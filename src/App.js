  ...
  <Router>
    <div className='dark:bg-[#212E37] dark:text-[#fff] h-screen w-screen' >
      ...
      <Switch>
       ...
       { isLoading ? details.map((detail,index) => <Card key={ index } detail={ detail } id={ detail.name } />) : <div className='mt-32 font-light text-center dark:text-[#fff] col-start-1 col-end-4'>Loading....</div> }
         </div>
       </Route>
